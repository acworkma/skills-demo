...
Paste the instructions below into your Copilot Studio agent's **Instructions** field. The governance rules, tiering logic, required reviews, controls, and output contract are loaded at runtime from the **Foundry Toolbox MCP endpoint** — they are not duplicated here.

---

## Instructions (paste into Copilot Studio → Instructions field)
